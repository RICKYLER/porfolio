  ...
  return (
    <footer className="border-t border-border bg-secondary/30 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="font-bold text-foreground">Ricky Contiga</span>
            </div>
            <p className="text-sm text-muted-foreground">Frontend Developer & Web3 UI Specialist</p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              {['About', 'Experience', 'Process', 'Contact'].map((link) => (
                <a
                  key={link}
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-secondary text-foreground hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-colors"
                aria-label="GitHub"
              >
        ...
        >
          <p className="text-sm text-muted-foreground">© {currentYear} Ricky Contiga. All rights reserved.</p>
          <button
            onClick={scrollToTop}
